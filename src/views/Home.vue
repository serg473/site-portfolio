...
<template>
  <section class="bg-white">
    <div class="mx-auto flex w-full max-w-7xl flex-col px-4 md:gap-12 md:px-8">
      <div class="flex flex-col md:justify-between md:gap-12 md:flex-row">
        <div class="flex justify-center  md:order-2 md:w-full">
          <img decoding="async" loading="lazy" class="mt-16 h-[254px] w-[229px]  md:h-[320px] md:w-[280px]"
            src="../assets/img/photo.webp" alt="Web Developer" />
        </div>
        <div class="mt-12 md:order-1">
          <h1
          ...
          <address class="my-12 md:my-8 not-italic text-base flex-col items-start leading-[150%] text-gray-600">
