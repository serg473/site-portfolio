...
<template>
    <div
        ...
        <div class="mt-6 flex flex-col gap-6 p-8 md:w-1/2 lg:p-12">
            ...
            <p class="text-normal text-base">{{ workItem?.description }}</p>
            <div class="flex flex-wrap gap-2">
                <div v-for="stack in workItem?.skills" :key="stack"
                ...
                :href="workItem?.link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
